...
class BotScheduleCalculation
  ...
  def createWateringInSchedule(crop, watering, coefficient)
	...
	new_item.execution_time = watering.time
  ...
  def getCoefficientForDay(crop, given_day)
